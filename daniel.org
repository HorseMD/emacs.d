...
(use-package yaml-mode      :disabled t)
...
(use-package calfw
  :ensure t
  :config (progn (require 'calfw-org)
...
(use-package smart-tabs-mode
  ...
  :ensure t
  :config (add-hook 'prog-mode-hook 'smart-tabs-mode))
#+end_src
...
(use-package evil-snipe
  ;; default snipe char is s/S, type to letters to swoop to it. s=forward, S=backward
  :ensure t
...
(setq org-capture-templates
      '(("t" "Todo" entry
         (file+datetree+prompt "./todo.org" "Todo")
         "* TODO %?\nWithin: %t")

        ("h" "Habit" entry
         (file+datetree+prompt "./habits.org" "Habits")
         "* TODO %?\nScheduled: %t")))
