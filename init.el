...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (package-lint phpunit company-php magit markdown-mode+ php-mode feature-mode org-plus-contrib pkgbuild-mode company company-mode ledger-mode hledger-mode kivy-mode glsl-mode atom-dark-theme ox-odt ox-odf which-key web-mode use-package tide rainbow-delimiters org-ref org-evil org-bullets markdown-mode lua-mode json-mode js2-refactor git-gutter-fringe geiser flymake-perlcritic evil-surround evil-quickscope counsel-projectile company-tern clj-refactor apropospriate-theme all-the-icons))))
(custom-set-faces
